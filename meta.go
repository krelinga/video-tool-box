...
func cmdNew(c *cli.Context) error {
    ...
    case "movie": t = ptMovie
    case "show": t = ptShow
    default: return fmt.Errorf("Invalid value of --type")
    }
    ps := &projectState {
        Name: name,
        Pt: t,
...
func cmdStage(c *cli.Context) error {
    ...
    switch {
    case working && !ready && !pushed: project.Stage = psWorking
    case !working && ready && !pushed: project.Stage = psReadyForPush
    case !working && !ready && pushed: project.Stage = psPushed
